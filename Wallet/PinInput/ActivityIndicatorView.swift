...
class ActivityIndicatorView: UIView {
    ...
    func showActivityIndicator() {
        if circleLayer == nil {
            ...
            circleLayer = WCGraintCircleLayer(bounds: self.bounds, position: CGPoint(x: radius, y: radius), fromColor: Constants.Colors.brandColor, toColor: UIColor.white, linewidth: 2.0)
        }
...
extension WCGraintCircleLayer {
    private func layerWithWithBounds(bounds:CGRect, position:CGPoint, fromColor:UIColor, toColor:UIColor, linewidth : CGFloat,toValue:CGFloat) -> WCGraintCircleLayer {
